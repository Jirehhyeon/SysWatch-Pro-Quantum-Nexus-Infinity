...
echo.
echo Installing ULTIMATE version packages...
...
echo - Standard: python SysWatch_Pro_QUANTUM_NEXUS_INFINITY.py
echo - ULTIMATE: python SysWatch_Pro_QUANTUM_NEXUS_INFINITY_ULTIMATE.py
echo.
echo Or use batch files:
